...
def parse_hash(input_hash)
	...
	hash[:social_link_slack] = slack_link.empty? ? "" : slack_link.first
	hash[:social_link_twitter] = twitter_link.empty? ? "" : twitter_link.first
	hash[:social_link_facebook] = facebook_link.empty? ? "" : facebook_link.first
	hash[:social_link_vk] = vk_link.empty? ? "" : vk_link.first
	hash[:social_link_github] = github_link.empty? ? "" : github_link.first
	hash[:social_link_reddit] = reddit_link.empty? ? "" : reddit_link.first
	hash[:social_link_bitcointalk] = bitcointalk_link.empty? ? "" : bitcointalk_link.first
	hash[:social_link_medium] = medium_link.empty? ? "" : medium_link.first
	hash[:social_link_telegram] = telegram_link.empty? ? "" : telegram_link.first
	hash[:social_link_youtube] = youtube_link.empty? ? "" : youtube_link.first
	hash[:social_link_website] = website_link.empty? || website_link.empty? ? "" : website_link
